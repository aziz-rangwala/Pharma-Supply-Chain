...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cryptogen" ]; then
    ...
    echo "##########################################################"
    echo "############ Create manufacture Identities ######################"
    echo "##########################################################"

    set -x
    cryptogen generate --config=./organizations/cryptogen/crypto-config-manufacture.yaml --output="organizations"
    res=$?
    set +x
    if [ $res -ne 0 ]; then
    ...
    echo "##########################################################"
    echo "############ Create Logistic Identities ######################"
    echo "##########################################################"
    ...
    echo "##########################################################"
    echo "############ Create Retailer Identities ######################"
    echo "##########################################################"
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    rm -rf organizations/fabric-ca/manufacture/msp organizations/fabric-ca/manufacture/tls-cert.pem organizations/fabric-ca/manufacture/ca-cert.pem organizations/fabric-ca/manufacture/IssuerPublicKey organizations/fabric-ca/manufacture/IssuerRevocationPublicKey organizations/fabric-ca/manufacture/fabric-ca-server.db
    rm -rf organizations/fabric-ca/logistics/msp organizations/fabric-ca/logistics/tls-cert.pem organizations/fabric-ca/logistics/ca-cert.pem organizations/fabric-ca/logistics/IssuerPublicKey organizations/fabric-ca/logistics/IssuerRevocationPublicKey organizations/fabric-ca/logistics/fabric-ca-server.db
    rm -rf organizations/fabric-ca/wholesaler/msp organizations/fabric-ca/wholesaler/tls-cert.pem organizations/fabric-ca/wholesaler/ca-cert.pem organizations/fabric-ca/wholesaler/IssuerPublicKey organizations/fabric-ca/wholesaler/IssuerRevocationPublicKey organizations/fabric-ca/wholesaler/fabric-ca-server.db
