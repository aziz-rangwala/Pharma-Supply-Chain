...
createAncorPeerTx() {
	...
	for orgmsp in manufactureMSP logisticsMSP wholesalerMSP retailerMSP customerMSP; do
...
echo "Join manufacture peers to the channel..."
joinChannel 1
echo "Join Logistics peers to the channel..."
joinChannel 2
echo "Join Wholesaler peers to the channel..."
joinChannel 3
echo "Join Retailer peers to the channel..."
joinChannel 4
...
echo "Updating anchor peers for manufacture..."
updateAnchorPeers 1
echo "Updating anchor peers for logistics..."
updateAnchorPeers 2
echo "Updating anchor peers for wholesaler..."
updateAnchorPeers 3
